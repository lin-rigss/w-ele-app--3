  ...
  <div class="addAddress">
    ...
    <div class="viewbody">
      <div class="content">
        ...
        <!-- 当点击地址时，让搜索地址的组件标记为true  并不是路由跳转  -->
        <FormBlock
        ...
        <div class="formblock">
          ...
          <!-- 标签组件   tags 所有的标签数据    selectTag 事件传递过来的选中标签               -->
...
export default {
  ...
  data() {
    return {
      ...
      tags: ["家", "学校", "公司"],
      sexes: ["先生", "女士"],
      addressInfo: {}, //  存储 所有表单添写的信息
      showSearch: false
    };
  },

  //  在 组件自己的路由守卫中 获取 路由传递的参数
  ...
  methods: {
    // 点击标签触发的事件  接收的是点击的那个标签
    checkTag(item) {
      // console.log(item);
      this.addressInfo.tag = item;
      // 将选中的标签赋值给  addressInfo.tag   再将传递给 子组件的 selectTag
    },
